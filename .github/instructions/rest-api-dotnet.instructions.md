...
applyTo: 'DevToBeCurious.FollowsCourses/**/*.cs, DevToBeCurious.FollowsCourses/**/*.json'
---
...
- ALWAYS use the newer Minimal API approach.
...
- Use Scalar for generating OpenAPI/Swagger documentation.
- Show how to document endpoints, parameters, responses, and authentication.
- Explain versioning in Minimal APIs.
...
- Guide users through creating unit tests for  Minimal API endpoints, and services.
