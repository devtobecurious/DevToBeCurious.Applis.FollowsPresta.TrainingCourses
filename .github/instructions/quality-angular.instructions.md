applyTo: 'trainingcourses-workspace/**/*.ts, trainingcourses-workspace/**/*.html, trainingcourses-workspace/**/*.scss, trainingcourses-workspace/**/*.css'
---
...
- When using Angular >= 17, prefer @if, @for, and @switch structural directives for cleaner templates
...
### Performance
- Enable production builds with `ng build` for optimization
- Use lazy loading for routes to reduce initial bundle size
- Optimize change detection with `OnPush` strategy and signals for fine-grained reactivity
- When using Angular <= 17, use trackBy in `ngFor` loops to improve rendering performance
